  ...
  return (
    <>
      ...
      <div style={{ padding: '18px 22px 80px', opacity: isPending ? 0.6 : 1, transition: 'opacity 0.15s' }}>
        ...
        <div className="layout-cardbank" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px,1fr))', gap: '12px' }}>
          {cards.map(card => {
            ...
            return (
              ...
              >
                ...
                {/* Portrait */}
                <div style={{ height: '100px', background: 'var(--bg2)', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
                  ...
                  <InfoPop {...INFO.composite_score}>
                    <div style={{ position: 'absolute', bottom: '6px', right: '7px', background: 'rgba(12,12,10,.75)', border: '0.5px solid var(--bd0)', borderRadius: '3px', padding: '1px 5px', fontFamily: '"DM Mono",monospace', fontSize: '11px', fontWeight: 500, color: 'var(--amber-b)' }}>
                      {score}
                    </div>
                  </InfoPop>
                </div>
                ...
                <div style={{ padding: '8px 10px 10px' }}>
                  <div style={{ fontFamily: '"Playfair Display",serif', fontSize: '12.5px', fontWeight: 600, color: 'var(--t1)', marginBottom: '2px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
