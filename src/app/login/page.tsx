      ...
      <div style={{ width: '100%', maxWidth: '400px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '9px', marginBottom: '6px' }}>
            <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: 'var(--amber-b)', display: 'inline-block', flexShrink: 0 }} />
            <span style={{ fontFamily: '"Playfair Display",serif', fontSize: '28px', fontStyle: 'italic', fontWeight: 600, color: 'var(--t1)' }}>
