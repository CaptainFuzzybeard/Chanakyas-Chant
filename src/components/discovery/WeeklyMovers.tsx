    ...
    >
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontSize: '11px', color: 'var(--stone-l, #C4B8A8)', marginTop: '1px' }}>
        ...
        <Link
          ...
          style={{
            fontSize: '12px', color: 'var(--saffron, #E8642A)',
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
        ...
        {/* Risers */}
        <div style={{ borderRight: '1px solid var(--cream-dark, #F0EBE1)' }}>
          <div style={{
            padding: '8px 14px',
  ...
  return (
    <Link
      ...
      style={{
        ...
        gap: '10px',
        padding: '9px 14px',
        borderBottom: isLast ? 'none' : '1px solid var(--cream-dark, #F0EBE1)',
        textDecoration: 'none',
        transition: 'background .12s',
      }}
      onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = 'var(--cream-dark, #F0EBE1)' }}
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{
          fontSize: '10px', color: 'var(--stone-l, #C4B8A8)',
          whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis',
        }}>
      ...
      <div style={{ textAlign: 'right', flexShrink: 0 }}>
        <div style={{
          ...
          color: 'var(--ink, #1A1208)', lineHeight: 1,
        }}>
        ...
        <div style={{
          ...
          color: isUp ? 'var(--green, #1B6B3A)' : 'var(--danger, #C0392B)',
        }}>
