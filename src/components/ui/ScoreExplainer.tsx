          ...
          >
            ...
            <div style={{ padding: '18px 20px' }}>
              ...
              <div style={{
                ...
                <strong style={{ color: 'var(--t1)', display: 'block', marginBottom: '3px' }}>
              ...
              {statRows.map(row => (
                ...
                >
                  ...
                  <div style={{ width: '118px', flexShrink: 0 }}>
                    ...
                    <div style={{ fontSize: '9.5px', color: 'var(--t4)', fontFamily: '"DM Mono",monospace' }}>
                ...
                <>
                  ...
                  {scamPenalty > 0 && (
                    <div style={{
                      ...
                      padding: '6px 0', borderBottom: '0.5px solid var(--bd0)',
                      fontSize: '12px',
                    }}>
                      <span style={{ color: 'var(--red)' }}>☁ Scam cloud</span>
                      <span style={{
                  ...
                  {biasPenalty > 0 && (
                    <div style={{
                      ...
                      <span style={{ color: 'var(--red)' }}>~ Bias penalty</span>
                      <span style={{
                        fontFamily: '"DM Mono",monospace', fontWeight: 500,
                        color: 'var(--red)',
                      }}>−{biasPenalty}</span>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <span style={{ fontSize: '12px', color: 'var(--t4)', marginLeft: '4px' }}>/1000</span>
                </div>
              </div>
              ...
              <div style={{
                ...
                color: 'var(--t4)', lineHeight: 1.5,
                borderTop: '0.5px solid var(--bd0)', paddingTop: '10px',
              }}>
                Scores are updated by automated analysis of news from{' '}
                <strong style={{ color: 'var(--t3)' }}>PIB, The Hindu, Indian Express, Reuters</strong>{' '}
